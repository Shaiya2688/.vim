...
if executable('rgb2cterm')
	nmap <silent> <leader>h3 :so ~/.vim/optional-tools/Vim-toCterm/tocterm.vim<CR>
endif
...
"mouse mode setting
set mouse=nvih
map <s-z> :<c-u>set mouse=nvih<cr>
map <s-x> :<c-u>set mouse=v<cr>
...
nmap <silent> fs :call JumpStack_DoJump('Cscope_Search', "s", expand("<cword>"))<cr>
nmap <silent> fg :call Cscope_Search("g", expand("<cword>"))<cr>
nmap <silent> fc :call JumpStack_DoJump('Cscope_Search', "c", expand("<cword>"))<cr>
nmap <silent> fi :call JumpStack_DoJump('Cscope_Search', "i", expand("<cword>"))<cr>
nmap <silent> ff :call JumpStack_DoJump('Cscope_Search', "f", expand("<cword>"))<cr>
nmap <silent> ft :call JumpStack_DoJump('Cscope_Search', "t", expand("<cword>"))<cr>
nmap <silent> fe :call JumpStack_DoJump('Cscope_Search', "e", expand("<cword>"))<cr>
nmap <silent> fa :call JumpStack_DoJump('Cscope_Search', "a", expand("<cword>"))<cr>
nmap <silent> fd :call JumpStack_DoJump('Cscope_Search', "d", expand("<cword>"))<cr>
vmap <silent> fs "9y:call JumpStack_DoJump('Cscope_Search', "s", @9)<cr>
vmap <silent> fg "9y:call Cscope_Search("g", @9)<cr>
vmap <silent> fc "9y:call JumpStack_DoJump('Cscope_Search', "c", @9)<cr>
vmap <silent> fi "9y:call JumpStack_DoJump('Cscope_Search', "i", @9)<cr>
vmap <silent> ff "9y:call JumpStack_DoJump('Cscope_Search', "f", @9)<cr>
vmap <silent> ft "9y:call JumpStack_DoJump('Cscope_Search', "t", @9)<cr>
vmap <silent> fe "9y:call JumpStack_DoJump('Cscope_Search', "e", @9)<cr>
vmap <silent> fa "9y:call JumpStack_DoJump('Cscope_Search', "a", @9)<cr>
vmap <silent> fd "9y:call JumpStack_DoJump('Cscope_Search', "d", @9)<cr>
nmap <silent> frs :call JumpStack_DoJump('Cscope_Search', "s")<cr>
nmap <silent> frg :call Cscope_Search("g")<cr>
nmap <silent> frc :call JumpStack_DoJump('Cscope_Search', "c")<cr>
nmap <silent> fri :call JumpStack_DoJump('Cscope_Search', "i")<cr>
nmap <silent> frf :call JumpStack_DoJump('Cscope_Search', "f")<cr>
nmap <silent> frt :call JumpStack_DoJump('Cscope_Search', "t")<cr>
nmap <silent> fre :call JumpStack_DoJump('Cscope_Search', "e")<cr>
nmap <silent> fra :call JumpStack_DoJump('Cscope_Search', "a")<cr>
nmap <silent> frd :call JumpStack_DoJump('Cscope_Search', "d")<cr>
...
" set <C-]> check &cst option, g<C-]> use default tags file
nn <silent> <C-]> :call Tag_Search()<CR>
nn <silent> g<C-]> :call Tag_Search(expand("<cword>"))<CR>
nn <silent> <C-LeftMouse> <LeftMouse>:call Tag_Search()<CR>
nn <silent> g<LeftMouse> <LeftMouse>:call Tag_Search()<CR>
vn <silent> <C-]> "9y:call Tag_Search(@9)<CR>
vn <silent> g<C-]> "9y:call Tag_Search(@9)<CR>
vn <silent> <C-LeftMouse> "9y:call Tag_Search(@9)<CR>
vn <silent> g<LeftMouse> "9y:call Tag_Search(@9)<CR>
...
func Tag_Search(...)
	let tag_mode = (a:0 > 0)
	let visual_pat = a:0 > 0 ? a:1 : expand("<cword>")
	let curidx= gettagstack().curidx
	...
	try
		...
		"visual mode search only working in nocst, cscope not have command or function do this
		if tag_mode && visual_pat != ''
			exe "tjump ".visual_pat
		else
			if !&cst
				call feedkeys("g\<c-]>", "!nx")
			else
				call feedkeys("\<c-]>", "!nx")
			endif
		endif
	...
	try
		...
		if (stack['length'] > 0 && stack['curidx'] > 1) "assert if :pop success
			...
			if type(locctx) == v:t_dict && has_key(locctx, 'from') && type(locctx.from) == v:t_list
				...
				if locfrom ==# popfrom && loctitle ==# poptagname
...
func JumpStack_LocationTagActive(...)
	...
	if (stack['length'] > 0 && stack['curidx'] > 1) "if have tag in stack
		...
		if type(locctx) == v:t_dict && has_key(locctx, 'from') && type(locctx.from) == v:t_list
			if locctx.from ==# from && loctitle ==# tagname
				return 1
			endif
		endif
	endif
...
func HelpCmdInfo()
	...
	call HelpCmdString("NONE-I", "fs/frs", "Find C symbol and list results in Locationlist window")
	call HelpCmdString("NONE-I", "fg/frg", "Find definition")
	call HelpCmdString("NONE-I", "fc/frc", "Find functions calling this function and list results in Locationlist window")
	call HelpCmdString("NONE-I", "fi/fri", "Find files #including this file and list results in Locationlist window")
	call HelpCmdString("NONE-I", "ff/frf", "Find this file and list results in Locationlist window")
	call HelpCmdString("NONE-I", "ft/frt", "Find text string and list results in Locationlist window")
	call HelpCmdString("NONE-I", "fe/fre", "Find egrep pattern and list results in Locationlist window")
	call HelpCmdString("NONE-I", "fa/fra", "Find places where this symbol is assigned a value and list results in Locationlist window")
